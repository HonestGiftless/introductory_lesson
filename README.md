...
<p align="center">Программе сначала вводятся координаты (x, y) клетки, в которой стоит король. Затем, вводятся координаты (x, y) клетки, куда должен попасть король. Необходимо определить, может ли король за 1 ход попасть в эту клетку.</p>
...
<h4 align="center">Слон</h4>
<p align="center">Программе сначала вводятся координаты (x, y) клетки, в которой стоит слон. Затем, вводятся координаты (x, y) клетки, куда должен попасть слон. Необходимо определить, может ли слон за 1 ход попасть в эту клетку.</p>
<p align="center">Примечание. Шахматный слон ходит по диагоналям.</p>

<p align="center">
  <img src="https://ucarecdn.com/eb6ad880-928b-4271-98f0-aefb193991d7/" align="center" width="200">
</p>
...
`4`<br>`4`<br>`5`<br>`5` | `YES`
`4`<br>`4`<br>`5`<br>`4` | `NO`
`4`<br>`4`<br>`5`<br>`3` | `YES`

<h4 align="center">Конь</h4>
<p align="center">Программе сначала вводятся координаты (x, y) клетки, в которой стоит конь. Затем, вводятся координаты (x, y) клетки, куда должен попасть конь. Необходимо определить, может ли конь за 1 ход попасть в эту клетку.</p>
<p align="center">Примечание. Шахматный конь ходит буквой «Г».</p>

<p align="center">
  <img src="https://ucarecdn.com/1611c614-daab-439b-8a5e-350cee84d150/" align="center" width="200">
</p>

Входные данные | Выходные данные
---------------|-----------------|
`1`<br>`1`<br>`8`<br>`8` | `NO`
`2`<br>`4`<br>`3`<br>`2` | `YES`

<h4 align="center">Калькулятор</h4>
<p align="center">Напишите простой калькулятор. Сначала, пользователь вводит 1 число. Затем вводит математическую операцию (+, -, *, /, //, %, **). Затем вводит 2 число. Необходимо вывести результат операции</p>
<p align="center">Примечание. Аккуратнее с делением на ноль:)</p>
